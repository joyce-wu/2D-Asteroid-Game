...
class App{
  ...
  registerEventHandlers() {
    ...
    this.canvas.onmousedown = (event) => {
      this.keysPressed["MOUSE_DOWN"] = true;
      this.keysPressed["CLIENT_X"] = event.clientX;
      this.keysPressed["CLIENT_Y"] = event.clientY;
    };
    this.canvas.onmousemove = (event) => {
      this.keysPressed["MOUSE_MOVE"] = true;
      this.keysPressed["CLIENT_X"] = event.clientX;
      this.keysPressed["CLIENT_Y"] = event.clientY;
    ...
    this.canvas.onmouseup = (event) => {
      this.keysPressed["MOUSE_DOWN"] = false;
    };
